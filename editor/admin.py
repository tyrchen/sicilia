...
class CountryAdmin(BaseAdmin):
  ...
  list_display = BaseAdmin.list_display + ('total_city_display', 'total_place_display', 'translated_city_display', 'translated_place_display', 'real_city_display', 'real_place_display')
