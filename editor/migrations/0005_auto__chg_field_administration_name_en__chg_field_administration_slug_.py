...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Administration.name_en'
        db.alter_column('editor_administration', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Administration.slug'
        db.alter_column('editor_administration', 'slug', self.gf('django.db.models.fields.CharField')(max_length=200, unique=True, null=True))

        # Changing field 'Continent.name_en'
        db.alter_column('editor_continent', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Continent.slug'
        db.alter_column('editor_continent', 'slug', self.gf('django.db.models.fields.CharField')(max_length=200, unique=True, null=True))

        # Changing field 'Country.name_en'
        db.alter_column('editor_country', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Country.slug'
        db.alter_column('editor_country', 'slug', self.gf('django.db.models.fields.CharField')(max_length=200, unique=True, null=True))

        # Changing field 'Place.name_en'
        db.alter_column('editor_place', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'Place.slug'
        db.alter_column('editor_place', 'slug', self.gf('django.db.models.fields.CharField')(max_length=200, unique=True, null=True))

        # Changing field 'City.name_en'
        db.alter_column('editor_city', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=100))

        # Changing field 'City.slug'
        db.alter_column('editor_city', 'slug', self.gf('django.db.models.fields.CharField')(max_length=200, unique=True, null=True))


    def backwards(self, orm):
        
        # Changing field 'Administration.name_en'
        db.alter_column('editor_administration', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Administration.slug'
        db.alter_column('editor_administration', 'slug', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100, null=True))

        # Changing field 'Continent.name_en'
        db.alter_column('editor_continent', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Continent.slug'
        db.alter_column('editor_continent', 'slug', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100, null=True))

        # Changing field 'Country.name_en'
        db.alter_column('editor_country', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Country.slug'
        db.alter_column('editor_country', 'slug', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100, null=True))

        # Changing field 'Place.name_en'
        db.alter_column('editor_place', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'Place.slug'
        db.alter_column('editor_place', 'slug', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100, null=True))

        # Changing field 'City.name_en'
        db.alter_column('editor_city', 'name_en', self.gf('django.db.models.fields.CharField')(max_length=50))

        # Changing field 'City.slug'
        db.alter_column('editor_city', 'slug', self.gf('django.db.models.fields.CharField')(unique=True, max_length=100, null=True))
    ...
    models = {
        ...
        'editor.administration': {
            ...
            'added_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 6, 11, 24, 34, 198168)'}),
            ...
            'last_modified_on': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 4, 6, 11, 24, 34, 198267)'}),
